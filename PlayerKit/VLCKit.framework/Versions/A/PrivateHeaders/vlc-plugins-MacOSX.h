...
int vlc_entry__codec_libvpx (int (*)(void *, void *, int, ...), void *);
int vlc_entry__video_output_macosx (int (*)(void *, void *, int, ...), void *);
int vlc_entry__video_output_macosx (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__demux_nsv (int (*)(void *, void *, int, ...), void *);
int vlc_entry__text_renderer_nsspeechsynthesizer (int (*)(void *, void *, int, ...), void *);
int vlc_entry__text_renderer_nsspeechsynthesizer (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__codec_cc (int (*)(void *, void *, int, ...), void *);
int vlc_entry__video_output_caopengllayer (int (*)(void *, void *, int, ...), void *);
int vlc_entry__video_output_caopengllayer (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__codec_avcodec_libavcodec (int (*)(void *, void *, int, ...), void *);
int vlc_entry__audio_output_auhal (int (*)(void *, void *, int, ...), void *);
int vlc_entry__audio_output_auhal (int (*)(void *, void *, int, ...), void *);
...
const void *vlc_static_modules[] = {
 ...
 vlc_entry__codec_libvpx,
 vlc_entry__video_output_macosx,
 vlc_entry__video_output_macosx,
 ...
 vlc_entry__codec_cc,
 vlc_entry__codec_cc,
 vlc_entry__video_output_caopengllayer,
 vlc_entry__video_output_caopengllayer,
